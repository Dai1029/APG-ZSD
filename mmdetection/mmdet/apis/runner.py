...
def copy_synthesised_weights_A(model, filename, dataset_name='voc', a1=0.35, a2=0.65, split='65_15'):
    ...
    alpha1 = a1
    alpha2 = a2
    own_state['bbox_head.fc_cls.bias'][0] = alpha1 * own_state['bbox_head.fc_cls.bias'][0] + alpha2 * \
                                            state_dict['fc1.bias'][0]
...
def copy_synthesised_weights(model, filename, dataset_name='voc', split='65_15'):
    ...
    own_state['bbox_head.fc_cls.weight'][0] = alpha1*own_state['bbox_head.fc_cls.weight'][0] + alpha2*state_dict['fc1.weight'][0]
...
def copy_synthesised_weights_inference(model, filename, dataset_name='voc', split='65_15'):
    logger = get_root_logger('INFO')
    ...
    alpha1 = 0.33
    alpha2 = 0.67
    own_state['bbox_head.fc_cls.bias'][0] = alpha1 * own_state['bbox_head.fc_cls.bias'][0].cuda() + alpha2 * \
                                            state_dict['fc1.bias'][0].cuda()
    own_state['bbox_head.fc_cls.weight'][0] = alpha1 * own_state['bbox_head.fc_cls.weight'][0].cuda() + alpha2 * \
