...
class VOCDataset(XMLDataset):
    ...
    def set_classes_split(self):
        ...
        self.seen_classes = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle',
                             'bus', 'cat', 'chair', 'cow', 'diningtable', 'horse',
    ...
    def load_annotations(self, ann_file,  classes_to_load=None, split=None):
        ...
        print(f"unseen classes loaded {np.unique(np.array(unseen_loaded))}")
