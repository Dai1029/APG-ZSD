...
from mmdet.apis.runner import copy_synthesised_weights, copy_synthesised_weights_A
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str)
    # apha1,apha2
    parser.add_argument('--a1', default=0.35, type=float, help='a1')
    parser.add_argument('--a2', default=0.65, type=float, help='a2')
...
def main():
    ...
    # todo dxm
    try:
        os.makedirs(args.out[:args.out.rfind("/")])
    except OSError:
        pass
    ...
    aph2 = args.a2
    if args.syn_weights:
        seen_bg_weight, seen_bg_bias = copy_synthesised_weights_A(model, args.syn_weights, dataset_name, aph1, aph2,
    ...
    if args.out and rank == 0:
        ...
        mean_ap, _ = eval(args.out, dataset, args.iou, dataset_name=dataset_name, split=cfg.data.test.split)
