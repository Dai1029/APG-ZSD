...
def parse_args():
    ...
    parser.add_argument('--datafeature_root', default='../data', help='path to dataset')
    parser.add_argument('--datalabel_root', default='../data', help='path to dataset')
    ...
    parser.add_argument('--bl', type=float, default=1.0,  help='seen / background')
    parser.add_argument('--cfxs', type=float, default=1.0, help='degree ')
    parser.add_argument('--unseen_num', type=int, default=5, help='unseen num')
